    ...
    return (
        <nav className="m-1 border-b-2 border-brown">
            <ul className="flex flex-row gap-8 px-8 py-2 text-xl">
                <li className={`flex-initial hover:bg-brown hover:text-tan hover:transition-all ${(currentPath.match(/\/home.*/)) ? "pointer-events-none bg-brown text-tan" : "bg-yellowgray"}`}>
                    <Link className={`block px-2 py-1 ${(currentPath.match(/\/home.*/)) ? "pointer-events-none" : ""}`} href="/">HOME</Link>
                </li>
